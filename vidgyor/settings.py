"""
Django settings for vidgyor project.
...
SECRET_KEY = '-f)01=@+i_m1nnl3)q@!v+i3loae_hf2nm9078@5hk!0o806()'
...
WSGI_APPLICATION = 'vidgyor.wsgi.application'
...
AUTHENTICATION_BACKENDS = ['django.contrib.auth.backends.ModelBackend', 'videos.backend.NewBackend']
# Password validation
